...
pub struct FireInspection {
    ...
    // Field used by fire dept.
    #[setters(doc = "Sets the value of the `class` field representing the business class.")]
    class: Option<String>,
    // Field used by fire dept.
    #[setters(doc = "Sets the value of the `subclass` field representing the business subclass.")]
    subclass: Option<String>,
}
